...
public partial class ECCubeSpawnerSystem : SystemBase
{
    protected override void OnUpdate()
    {
        ...
        Entities.ForEach((Entity entity, ref ECCubeSpawner spawner) => 
        {
            Random random = Random.CreateFromIndex(1);
            ECStateMachine stateMachine = GetComponent<ECStateMachine>(spawner.CubePrefab);

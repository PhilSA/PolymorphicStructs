...
[Serializable]
public partial struct StateB : IMyState, IComponentData // IComponentData is only there for the "Structural changes" version
{
    ...
    public void OnStateUpdate(ref StateUpdateData_ReadWrite refData, in StateUpdateData_ReadOnly inData)
    {
        ...
        {
            refData.StateMachine.TransitionToStateIndex = (int)MyState.TypeId.StateC;
        }
    }
}
